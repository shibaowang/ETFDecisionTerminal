...
def main() -> int:
    ...
    shell_accounting_production_trading_ui_implementation_path = (
        root / "docs" / "106_shell_accounting_production_trading_ui_implementation.md"
    )
    shell_accounting_broker_order_authorization_gate_path = (
        root / "docs" / "107_shell_accounting_broker_order_authorization_gate.md"
    )
    ...
    shell_accounting_real_broker_order_authorization_gate_path = (
        root / "docs" / "110_shell_accounting_real_broker_order_authorization_gate.md"
    )
    shell_accounting_real_broker_order_authorization_test_plan_path = (
        root / "docs" / "111_shell_accounting_real_broker_order_authorization_test_plan.md"
    )
    shell_accounting_real_broker_order_implementation_gate_path = (
        root / "docs" / "112_shell_accounting_real_broker_order_implementation_gate.md"
    )
    shell_accounting_real_broker_order_implementation_test_plan_path = (
        root / "docs" / "113_shell_accounting_real_broker_order_implementation_test_plan.md"
    )
    ...
    shell_accounting_broker_sandbox_adapter_authorization_gate_path = (
        root / "docs" / "118_shell_accounting_broker_sandbox_adapter_authorization_gate.md"
    )
    ...
    shell_accounting_broker_sandbox_mode_selector_path = (
        root / "docs" / "122_shell_accounting_broker_sandbox_mode_selector.md"
    )
    shell_accounting_broker_sandbox_mode_selector_test_plan_path = (
        root / "docs" / "123_shell_accounting_broker_sandbox_mode_selector_test_plan.md"
    )
    shell_accounting_broker_sandbox_runtime_selector_authorization_gate_path = (
        root / "docs" / "124_shell_accounting_broker_sandbox_runtime_selector_authorization_gate.md"
    )
    shell_accounting_broker_sandbox_runtime_selector_authorization_test_plan_path = (
        root / "docs" / "125_shell_accounting_broker_sandbox_runtime_selector_authorization_test_plan.md"
    )
    shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_path = (
        root / "docs" / "126_shell_accounting_broker_sandbox_runtime_selector_disabled_wiring.md"
    )
    shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_test_plan_path = (
        root / "docs" / "127_shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_test_plan.md"
    )
    shell_accounting_broker_runtime_mode_source_authorization_gate_path = (
        root / "docs" / "128_shell_accounting_broker_runtime_mode_source_authorization_gate.md"
    )
    shell_accounting_broker_runtime_mode_source_authorization_test_plan_path = (
        root / "docs" / "129_shell_accounting_broker_runtime_mode_source_authorization_test_plan.md"
    )
    shell_accounting_broker_runtime_mode_source_disabled_scaffold_path = (
        root / "docs" / "130_shell_accounting_broker_runtime_mode_source_disabled_scaffold.md"
    )
    shell_accounting_broker_runtime_mode_source_disabled_scaffold_test_plan_path = (
        root / "docs" / "131_shell_accounting_broker_runtime_mode_source_disabled_scaffold_test_plan.md"
    )
    shell_accounting_broker_sandbox_runtime_mode_source_authorization_gate_path = (
        root / "docs" / "132_shell_accounting_broker_sandbox_runtime_mode_source_authorization_gate.md"
    )
    shell_accounting_broker_sandbox_runtime_mode_source_authorization_test_plan_path = (
        root / "docs" / "133_shell_accounting_broker_sandbox_runtime_mode_source_authorization_test_plan.md"
    )
    shell_accounting_broker_sandbox_runtime_mode_source_scaffold_path = (
        root / "docs" / "134_shell_accounting_broker_sandbox_runtime_mode_source_scaffold.md"
    )
    shell_accounting_broker_sandbox_runtime_mode_source_scaffold_test_plan_path = (
        root / "docs" / "135_shell_accounting_broker_sandbox_runtime_mode_source_scaffold_test_plan.md"
    )
    shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_gate_path = (
        root / "docs" / "136_shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_gate.md"
    )
    ...
    shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_gate_path = (
        root / "docs" / "144_shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_gate.md"
    )
    shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_test_plan_path = (
        root / "docs" / "145_shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_test_plan.md"
    )
    shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_path = (
        root / "docs" / "146_shell_accounting_broker_sandbox_runtime_enablement_state_scaffold.md"
    )
    ...
    shell_accounting_production_trading_ui_implementation_cmake_path = (
        root / "tests" / "ShellAccountingProductionTradingUiImplementation" / "CMakeLists.txt"
    )
    ...
    shell_accounting_real_broker_order_authorization_gate_cmake_path = (
        root / "tests" / "ShellAccountingRealBrokerOrderAuthorizationGate" / "CMakeLists.txt"
    )
    shell_accounting_real_broker_order_implementation_gate_cmake_path = (
        root / "tests" / "ShellAccountingRealBrokerOrderImplementationGate" / "CMakeLists.txt"
    )
    ...
    shell_accounting_broker_sandbox_mode_selector_cmake_path = (
        root / "tests" / "ShellAccountingBrokerSandboxModeSelector" / "CMakeLists.txt"
    )
    shell_accounting_broker_sandbox_runtime_selector_authorization_cmake_path = (
        root / "tests" / "ShellAccountingBrokerSandboxRuntimeSelectorAuthorizationGate" / "CMakeLists.txt"
    )
    shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_cmake_path = (
        root / "tests" / "ShellAccountingBrokerSandboxRuntimeSelectorDisabledWiring" / "CMakeLists.txt"
    )
    shell_accounting_broker_runtime_mode_source_authorization_cmake_path = (
        root / "tests" / "ShellAccountingBrokerRuntimeModeSourceAuthorizationGate" / "CMakeLists.txt"
    )
    shell_accounting_broker_runtime_mode_source_disabled_scaffold_cmake_path = (
        root / "tests" / "ShellAccountingBrokerRuntimeModeSourceDisabledScaffold" / "CMakeLists.txt"
    )
    shell_accounting_broker_sandbox_runtime_mode_source_authorization_cmake_path = (
        root / "tests" / "ShellAccountingBrokerSandboxRuntimeModeSourceAuthorizationGate" / "CMakeLists.txt"
    )
    shell_accounting_broker_sandbox_runtime_mode_source_scaffold_cmake_path = (
        root / "tests" / "ShellAccountingBrokerSandboxRuntimeModeSourceScaffold" / "CMakeLists.txt"
    )
    ...
    shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_cmake_path = (
        root / "tests" / "ShellAccountingBrokerSandboxRuntimeModeEnablementAuthorizationGate" / "CMakeLists.txt"
    )
    ...
    shell_accounting_production_trading_ui_implementation = (
        shell_accounting_production_trading_ui_implementation_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_order_authorization_gate = (
        shell_accounting_broker_order_authorization_gate_path.read_text(encoding="utf-8")
    )
    ...
    shell_accounting_real_broker_order_authorization_gate = (
        shell_accounting_real_broker_order_authorization_gate_path.read_text(encoding="utf-8")
    )
    shell_accounting_real_broker_order_authorization_test_plan = (
        shell_accounting_real_broker_order_authorization_test_plan_path.read_text(encoding="utf-8")
    )
    shell_accounting_real_broker_order_implementation_gate = (
        shell_accounting_real_broker_order_implementation_gate_path.read_text(encoding="utf-8")
    )
    shell_accounting_real_broker_order_implementation_test_plan = (
        shell_accounting_real_broker_order_implementation_test_plan_path.read_text(encoding="utf-8")
    )
    ...
    shell_accounting_broker_sandbox_adapter_authorization_gate = (
        shell_accounting_broker_sandbox_adapter_authorization_gate_path.read_text(encoding="utf-8")
    )
    ...
    shell_accounting_broker_sandbox_mode_selector = (
        shell_accounting_broker_sandbox_mode_selector_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_mode_selector_test_plan = (
        shell_accounting_broker_sandbox_mode_selector_test_plan_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_selector_authorization_gate = (
        shell_accounting_broker_sandbox_runtime_selector_authorization_gate_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_selector_authorization_test_plan = (
        shell_accounting_broker_sandbox_runtime_selector_authorization_test_plan_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_selector_disabled_wiring = (
        shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_test_plan = (
        shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_test_plan_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_runtime_mode_source_authorization_gate = (
        shell_accounting_broker_runtime_mode_source_authorization_gate_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_runtime_mode_source_authorization_test_plan = (
        shell_accounting_broker_runtime_mode_source_authorization_test_plan_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_runtime_mode_source_disabled_scaffold = (
        shell_accounting_broker_runtime_mode_source_disabled_scaffold_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_runtime_mode_source_disabled_scaffold_test_plan = (
        shell_accounting_broker_runtime_mode_source_disabled_scaffold_test_plan_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_mode_source_authorization_gate = (
        shell_accounting_broker_sandbox_runtime_mode_source_authorization_gate_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_mode_source_authorization_test_plan = (
        shell_accounting_broker_sandbox_runtime_mode_source_authorization_test_plan_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_mode_source_scaffold = (
        shell_accounting_broker_sandbox_runtime_mode_source_scaffold_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_mode_source_scaffold_test_plan = (
        shell_accounting_broker_sandbox_runtime_mode_source_scaffold_test_plan_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_gate = (
        shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_gate_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_test_plan = (
        shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_test_plan_path.read_text(
            encoding="utf-8"
        )
    )
    ...
    shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_gate = (
        shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_gate_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_test_plan = (
        shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_test_plan_path.read_text(
            encoding="utf-8"
        )
    )
    shell_accounting_broker_sandbox_runtime_enablement_state_scaffold = (
        shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_path.read_text(encoding="utf-8")
    )
    ...
    shell_accounting_production_trading_ui_implementation_cmake = (
        shell_accounting_production_trading_ui_implementation_cmake_path.read_text(encoding="utf-8")
    )
    ...
    shell_accounting_real_broker_order_authorization_gate_cmake = (
        shell_accounting_real_broker_order_authorization_gate_cmake_path.read_text(encoding="utf-8")
    )
    shell_accounting_real_broker_order_implementation_gate_cmake = (
        shell_accounting_real_broker_order_implementation_gate_cmake_path.read_text(encoding="utf-8")
    )
    ...
    shell_accounting_broker_sandbox_mode_selector_cmake = (
        shell_accounting_broker_sandbox_mode_selector_cmake_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_selector_authorization_cmake = (
        shell_accounting_broker_sandbox_runtime_selector_authorization_cmake_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_cmake = (
        shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_cmake_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_runtime_mode_source_authorization_cmake = (
        shell_accounting_broker_runtime_mode_source_authorization_cmake_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_runtime_mode_source_disabled_scaffold_cmake = (
        shell_accounting_broker_runtime_mode_source_disabled_scaffold_cmake_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_mode_source_authorization_cmake = (
        shell_accounting_broker_sandbox_runtime_mode_source_authorization_cmake_path.read_text(encoding="utf-8")
    )
    shell_accounting_broker_sandbox_runtime_mode_source_scaffold_cmake = (
        shell_accounting_broker_sandbox_runtime_mode_source_scaffold_cmake_path.read_text(encoding="utf-8")
    )
    ...
    shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_cmake = (
        shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_cmake_path.read_text(encoding="utf-8")
    )
    ...
    for forbidden_shell_token in ["SQLiteConnection", "DataAccess", "AccountingReplayEngine"]:
        require(
    ...
    require(
        "handleAccountingSnapshotWrite" in data_service_actions_source
        and "accounting.snapshot.write" in dataservice_actions_header
        and "kActionAccountingSnapshotWrite" in dataservice_action_registrar,
        "TASK-144 registers authorized snapshot write action",
    )
    require(
        "INSERT INTO cash_snapshot" not in data_service_actions_source
        and "INSERT INTO position_snapshot" not in data_service_actions_source
        and "INSERT INTO portfolio_summary" not in data_service_actions_source,
        "TASK-144 keeps snapshot write SQL out of DataService action dispatcher",
    )
    require(
        "TASK-143" in readme
    ...
    require(
        shell_accounting_snapshot_write_implementation_path.exists(),
        "docs/94 snapshot write implementation exists",
    )
    require(
        shell_accounting_snapshot_write_implementation_cmake_path.exists(),
        "TASK-144 snapshot write implementation CMake exists",
    )
    require(
        "docs/94_shell_accounting_snapshot_write_implementation.md" in readme,
        "README links docs/94",
    )
    require(
        "94_shell_accounting_snapshot_write_implementation.md" in docs_index,
        "docs/README links docs/94",
    )
    require("TASK-144" in shell_accounting_snapshot_write_implementation, "docs/94 mentions TASK-144")
    require("TASK-144" in codex_prompt_template, "docs/12 mentions TASK-144")
    require("TASK-144" in shell_accounting_snapshot_write_authorization_gate, "docs/92 mentions TASK-144")
    require("TASK-144" in shell_accounting_snapshot_write_authorization_test_plan, "docs/93 mentions TASK-144")
    require("accounting.snapshot.write" in shell_accounting_snapshot_write_implementation, "docs/94 records action")
    require("TASK-144_SNAPSHOT_WRITE" in shell_accounting_snapshot_write_implementation, "docs/94 records authorization")
    require("cash_snapshot" in shell_accounting_snapshot_write_implementation, "docs/94 records cash snapshot allowlist")
    require("position_snapshot" in shell_accounting_snapshot_write_implementation, "docs/94 records position snapshot allowlist")
    require("portfolio_summary" in shell_accounting_snapshot_write_implementation, "docs/94 records portfolio summary allowlist")
    require("trade_log" in shell_accounting_snapshot_write_implementation, "docs/94 records forbidden trade_log")
    require("audit_log" in shell_accounting_snapshot_write_implementation, "docs/94 records forbidden audit_log")
    require("rollback" in shell_accounting_snapshot_write_implementation, "docs/94 includes rollback")
    require("partial write forbidden" in shell_accounting_snapshot_write_implementation, "docs/94 forbids partial writes")
    for ctest_name in [
        "shell_accounting_snapshot_write_implementation",
        ...
        require(
            ctest_name in shell_accounting_snapshot_write_implementation_cmake,
            f"TASK-144 tests include {ctest_name}",
        )
    snapshot_write_repository_source = (
        root / "libs" / "DataAccess" / "src" / "ShellAccountingSnapshotWriteRepository.cpp"
    ).read_text(encoding="utf-8")
    for allowed_insert in [
        "INSERT INTO cash_snapshot",
        "INSERT INTO position_snapshot",
        "INSERT INTO portfolio_summary",
    ]:
        require(allowed_insert in snapshot_write_repository_source, f"TASK-144 repository writes {allowed_insert}")
    for forbidden_insert in [
        ...
        require(
            forbidden_insert not in snapshot_write_repository_source,
            f"TASK-144 repository avoids {forbidden_insert}",
        )
    require(
        "ShellAccountingSnapshotWriteRepository" not in qml_sources
        and "accounting.snapshot.write" not in qml_sources,
        "production QML does not trigger snapshot write",
    )
    require(
        "ShellAccountingSnapshotWriteRepository"
        not in (root / "apps" / "ETFDecisionShell" / "src" / "main.cpp").read_text(encoding="utf-8")
        and "accounting.snapshot.write"
        not in (root / "apps" / "ETFDecisionShell" / "src" / "main.cpp").read_text(encoding="utf-8"),
        "production startup does not trigger snapshot write",
    )
    require(
        "TASK-144" in readme
    ...
    require(
        shell_accounting_tradedraft_confirmation_implementation_path.exists(),
        "docs/103 TradeDraft confirmation implementation exists",
    )
    require(
        shell_accounting_tradedraft_confirmation_implementation_cmake_path.exists(),
        "TASK-150 TradeDraft confirmation implementation tests exist",
    )
    require(
        "docs/103_shell_accounting_tradedraft_confirmation_implementation.md" in readme,
        "README links docs/103",
    )
    require(
        "103_shell_accounting_tradedraft_confirmation_implementation.md" in docs_index,
        "docs/README links docs/103",
    )
    require("TASK-150" in shell_accounting_tradedraft_confirmation_implementation, "docs/103 mentions TASK-150")
    require("TASK-150" in shell_accounting_tradedraft_confirmation_authorization_gate, "docs/101 mentions TASK-150")
    require(
        "TASK-150" in shell_accounting_tradedraft_confirmation_authorization_test_plan,
        "docs/102 mentions TASK-150",
    )
    require("TASK-150" in codex_prompt_template, "docs/12 mentions TASK-150")
    for ctest_name in [
        "shell_accounting_tradedraft_confirmation_implementation",
        "shell_accounting_tradedraft_confirmation_dataservice_only_boundary",
        "shell_accounting_tradedraft_confirmation_requires_authorization",
        "shell_accounting_tradedraft_confirmation_disabled_mapping",
        "shell_accounting_tradedraft_confirmation_success",
        "shell_accounting_tradedraft_confirmation_draft_missing",
        "shell_accounting_tradedraft_confirmation_already_confirmed",
        "shell_accounting_tradedraft_confirmation_canceled_draft",
        "shell_accounting_tradedraft_confirmation_stale_draft",
        "shell_accounting_tradedraft_confirmation_invalid_payload",
        "shell_accounting_tradedraft_confirmation_atomic_ledger_write",
        "shell_accounting_tradedraft_confirmation_audit_event_required",
        "shell_accounting_tradedraft_confirmation_audit_failure_rolls_back",
        "shell_accounting_tradedraft_confirmation_transaction_rollback",
        "shell_accounting_tradedraft_confirmation_idempotency",
        "shell_accounting_tradedraft_confirmation_duplicate_handling",
        "shell_accounting_tradedraft_confirmation_writes_trade_log",
        "shell_accounting_tradedraft_confirmation_writes_execution_group",
        "shell_accounting_tradedraft_confirmation_updates_draft_status",
        "shell_accounting_tradedraft_confirmation_no_broker_order",
        "shell_accounting_tradedraft_confirmation_no_strategy_execution",
        "shell_accounting_tradedraft_confirmation_no_ui_trigger",
        "shell_accounting_tradedraft_confirmation_privacy",
        "shell_accounting_tradedraft_confirmation_rollback_ready",
    ]:
        require(
            ctest_name in shell_accounting_tradedraft_confirmation_implementation_cmake,
            f"TASK-150 tests include {ctest_name}",
        )
    confirmation_repository_source = (
        root / "libs" / "DataAccess" / "src" / "ShellAccountingTradeDraftConfirmationRepository.cpp"
    ).read_text(encoding="utf-8")
    require(
        "INSERT INTO trade_execution_group" in confirmation_repository_source
        and "INSERT INTO trade_log" in confirmation_repository_source,
        "TASK-150 repository writes execution group and trade_log",
    )
    require(
        "UPDATE trade_draft SET status" in confirmation_repository_source,
        "TASK-150 repository updates confirmed draft status",
    )
    require(
        "AuditLogRepository" in confirmation_repository_source
        and "insertAuditLog" in confirmation_repository_source,
        "TASK-150 repository writes sanitized audit event",
    )
    require(
        "accounting.tradedraft.confirm" in data_service_actions_source
        and "TASK-150_TRADEDRAFT_CONFIRM" in data_service_actions_source,
        "DataService action source wires TASK-150 confirmation",
    )
    for forbidden_confirmation_token in [
        "BrokerAdapter",
        "brokerOrder(",
        "placeOrder(",
        "executeOrder(",
    ...
    require(
        "docs/106_shell_accounting_production_trading_ui_implementation.md" in readme,
        "README links docs/106",
    )
    require(
        shell_accounting_broker_order_authorization_gate_path.exists(),
        "docs/107 broker order authorization gate exists",
    )
    require(
        shell_accounting_broker_order_authorization_test_plan_path.exists(),
    ...
    require(
        shell_accounting_real_broker_order_authorization_gate_path.exists(),
        "docs/110 real broker order authorization gate exists",
    )
    require(
        shell_accounting_real_broker_order_authorization_test_plan_path.exists(),
        "docs/111 real broker order authorization test plan exists",
    )
    require(
        shell_accounting_real_broker_order_implementation_gate_path.exists(),
        "docs/112 real broker order implementation gate exists",
    )
    require(
        shell_accounting_real_broker_order_implementation_test_plan_path.exists(),
        "docs/113 real broker order implementation test plan exists",
    )
    require(
        shell_accounting_broker_adapter_interface_scaffold_path.exists(),
    ...
    require(
        shell_accounting_broker_sandbox_adapter_authorization_gate_path.exists(),
        "docs/118 broker sandbox adapter authorization gate exists",
    )
    require(
        shell_accounting_broker_sandbox_adapter_authorization_test_plan_path.exists(),
    ...
    require(
        shell_accounting_broker_sandbox_mode_selector_path.exists(),
        "docs/122 broker sandbox mode selector exists",
    )
    require(
        shell_accounting_broker_sandbox_mode_selector_test_plan_path.exists(),
        "docs/123 broker sandbox mode selector test plan exists",
    )
    require(
        shell_accounting_broker_sandbox_runtime_selector_authorization_gate_path.exists(),
        "docs/124 broker sandbox runtime selector authorization gate exists",
    )
    require(
        shell_accounting_broker_sandbox_runtime_selector_authorization_test_plan_path.exists(),
        "docs/125 broker sandbox runtime selector authorization test plan exists",
    )
    require(
        shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_path.exists(),
        "docs/126 broker sandbox runtime selector disabled wiring exists",
    )
    require(
        shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_test_plan_path.exists(),
        "docs/127 broker sandbox runtime selector disabled wiring test plan exists",
    )
    require(
        shell_accounting_broker_runtime_mode_source_authorization_gate_path.exists(),
        "docs/128 broker runtime mode source authorization gate exists",
    )
    require(
        shell_accounting_broker_runtime_mode_source_authorization_test_plan_path.exists(),
        "docs/129 broker runtime mode source authorization test plan exists",
    )
    require(
        shell_accounting_broker_runtime_mode_source_disabled_scaffold_path.exists(),
        "docs/130 broker runtime mode source disabled scaffold exists",
    )
    require(
        shell_accounting_broker_runtime_mode_source_disabled_scaffold_test_plan_path.exists(),
        "docs/131 broker runtime mode source disabled scaffold test plan exists",
    )
    require(
        shell_accounting_broker_sandbox_runtime_mode_source_authorization_gate_path.exists(),
        "docs/132 broker sandbox runtime mode source authorization gate exists",
    )
    require(
        shell_accounting_broker_sandbox_runtime_mode_source_authorization_test_plan_path.exists(),
        "docs/133 broker sandbox runtime mode source authorization test plan exists",
    )
    require(
        shell_accounting_broker_sandbox_runtime_mode_source_scaffold_path.exists(),
        "docs/134 broker sandbox runtime mode source scaffold exists",
    )
    require(
        shell_accounting_broker_sandbox_runtime_mode_source_scaffold_test_plan_path.exists(),
        "docs/135 broker sandbox runtime mode source scaffold test plan exists",
    )
    require(
        shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_gate_path.exists(),
        "docs/136 broker sandbox runtime mode source selector authorization gate exists",
    )
    require(
        shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_test_plan_path.exists(),
    ...
    require(
        shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_gate_path.exists(),
        "docs/144 broker sandbox runtime mode enablement authorization gate exists",
    )
    require(
        shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_test_plan_path.exists(),
        "docs/145 broker sandbox runtime mode enablement authorization test plan exists",
    )
    require(
        shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_path.exists(),
        "docs/146 broker sandbox runtime enablement state scaffold exists",
    )
    require(
        shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_test_plan_path.exists(),
    ...
    require(
        "docs/110_shell_accounting_real_broker_order_authorization_gate.md" in readme,
        "README links docs/110",
    )
    require(
        "docs/111_shell_accounting_real_broker_order_authorization_test_plan.md" in readme,
        "README links docs/111",
    )
    require(
        "docs/112_shell_accounting_real_broker_order_implementation_gate.md" in readme,
        "README links docs/112",
    )
    require(
        "docs/113_shell_accounting_real_broker_order_implementation_test_plan.md" in readme,
        "README links docs/113",
    )
    require(
    ...
    require(
        "docs/118_shell_accounting_broker_sandbox_adapter_authorization_gate.md" in readme,
        "README links docs/118",
    )
    require(
    ...
    require(
        "docs/122_shell_accounting_broker_sandbox_mode_selector.md" in readme,
        "README links docs/122",
    )
    require(
        "docs/123_shell_accounting_broker_sandbox_mode_selector_test_plan.md" in readme,
        "README links docs/123",
    )
    require(
        "docs/124_shell_accounting_broker_sandbox_runtime_selector_authorization_gate.md" in readme,
        "README links docs/124",
    )
    require(
        "docs/125_shell_accounting_broker_sandbox_runtime_selector_authorization_test_plan.md" in readme,
        "README links docs/125",
    )
    require(
        "docs/126_shell_accounting_broker_sandbox_runtime_selector_disabled_wiring.md" in readme,
        "README links docs/126",
    )
    require(
        "docs/127_shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_test_plan.md" in readme,
        "README links docs/127",
    )
    require(
        "docs/128_shell_accounting_broker_runtime_mode_source_authorization_gate.md" in readme,
        "README links docs/128",
    )
    require(
        "docs/129_shell_accounting_broker_runtime_mode_source_authorization_test_plan.md" in readme,
        "README links docs/129",
    )
    require(
        "docs/130_shell_accounting_broker_runtime_mode_source_disabled_scaffold.md" in readme,
        "README links docs/130",
    )
    require(
        "docs/131_shell_accounting_broker_runtime_mode_source_disabled_scaffold_test_plan.md" in readme,
        "README links docs/131",
    )
    require(
        "docs/132_shell_accounting_broker_sandbox_runtime_mode_source_authorization_gate.md" in readme,
        "README links docs/132",
    )
    require(
        "docs/133_shell_accounting_broker_sandbox_runtime_mode_source_authorization_test_plan.md" in readme,
        "README links docs/133",
    )
    require(
        "docs/134_shell_accounting_broker_sandbox_runtime_mode_source_scaffold.md" in readme,
        "README links docs/134",
    )
    require(
        "docs/135_shell_accounting_broker_sandbox_runtime_mode_source_scaffold_test_plan.md" in readme,
        "README links docs/135",
    )
    require(
        "docs/136_shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_gate.md" in readme,
        "README links docs/136",
    )
    require(
    ...
    require(
        "docs/144_shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_gate.md" in readme,
        "README links docs/144",
    )
    require(
        "docs/145_shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_test_plan.md" in readme,
        "README links docs/145",
    )
    require(
        "docs/146_shell_accounting_broker_sandbox_runtime_enablement_state_scaffold.md" in readme,
        "README links docs/146",
    )
    require(
    ...
    require(
        "106_shell_accounting_production_trading_ui_implementation.md" in docs_index,
        "docs/README links docs/106",
    )
    require(
        "107_shell_accounting_broker_order_authorization_gate.md" in docs_index,
        "docs/README links docs/107",
    )
    require(
    ...
    require(
        "110_shell_accounting_real_broker_order_authorization_gate.md" in docs_index,
        "docs/README links docs/110",
    )
    require(
        "111_shell_accounting_real_broker_order_authorization_test_plan.md" in docs_index,
        "docs/README links docs/111",
    )
    require(
        "112_shell_accounting_real_broker_order_implementation_gate.md" in docs_index,
        "docs/README links docs/112",
    )
    require(
        "113_shell_accounting_real_broker_order_implementation_test_plan.md" in docs_index,
        "docs/README links docs/113",
    )
    require(
    ...
    require(
        "118_shell_accounting_broker_sandbox_adapter_authorization_gate.md" in docs_index,
        "docs/README links docs/118",
    )
    require(
    ...
    require(
        "122_shell_accounting_broker_sandbox_mode_selector.md" in docs_index,
        "docs/README links docs/122",
    )
    require(
        "123_shell_accounting_broker_sandbox_mode_selector_test_plan.md" in docs_index,
        "docs/README links docs/123",
    )
    require(
        "124_shell_accounting_broker_sandbox_runtime_selector_authorization_gate.md" in docs_index,
        "docs/README links docs/124",
    )
    require(
        "125_shell_accounting_broker_sandbox_runtime_selector_authorization_test_plan.md" in docs_index,
        "docs/README links docs/125",
    )
    require(
        "126_shell_accounting_broker_sandbox_runtime_selector_disabled_wiring.md" in docs_index,
        "docs/README links docs/126",
    )
    require(
        "127_shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_test_plan.md" in docs_index,
        "docs/README links docs/127",
    )
    require(
        "128_shell_accounting_broker_runtime_mode_source_authorization_gate.md" in docs_index,
        "docs/README links docs/128",
    )
    require(
        "129_shell_accounting_broker_runtime_mode_source_authorization_test_plan.md" in docs_index,
        "docs/README links docs/129",
    )
    require(
        "130_shell_accounting_broker_runtime_mode_source_disabled_scaffold.md" in docs_index,
        "docs/README links docs/130",
    )
    require(
        "131_shell_accounting_broker_runtime_mode_source_disabled_scaffold_test_plan.md" in docs_index,
        "docs/README links docs/131",
    )
    require(
        "132_shell_accounting_broker_sandbox_runtime_mode_source_authorization_gate.md" in docs_index,
        "docs/README links docs/132",
    )
    require(
        "133_shell_accounting_broker_sandbox_runtime_mode_source_authorization_test_plan.md" in docs_index,
        "docs/README links docs/133",
    )
    require(
        "134_shell_accounting_broker_sandbox_runtime_mode_source_scaffold.md" in docs_index,
        "docs/README links docs/134",
    )
    require(
        "135_shell_accounting_broker_sandbox_runtime_mode_source_scaffold_test_plan.md" in docs_index,
        "docs/README links docs/135",
    )
    require(
        "136_shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_gate.md" in docs_index,
        "docs/README links docs/136",
    )
    require(
    ...
    require(
        "144_shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_gate.md" in docs_index,
        "docs/README links docs/144",
    )
    require(
        "145_shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_test_plan.md" in docs_index,
        "docs/README links docs/145",
    )
    require(
        "146_shell_accounting_broker_sandbox_runtime_enablement_state_scaffold.md" in docs_index,
        "docs/README links docs/146",
    )
    require(
    ...
    require("TASK-152" in shell_accounting_production_trading_ui_implementation, "docs/106 mentions TASK-152")
    require("TASK-152" in codex_prompt_template, "docs/12 mentions TASK-152")
    require("TASK-153" in shell_accounting_broker_order_authorization_gate, "docs/107 mentions TASK-153")
    require(
        "Test Matrix" in shell_accounting_broker_order_authorization_test_plan,
    ...
    require("TASK-155" in shell_accounting_real_broker_order_authorization_gate, "docs/110 mentions TASK-155")
    require(
        "Test Matrix" in shell_accounting_real_broker_order_authorization_test_plan,
        "docs/111 contains Test matrix",
    )
    require("TASK-155" in codex_prompt_template, "docs/12 mentions TASK-155")
    require("dry-run result required" in shell_accounting_real_broker_order_authorization_gate, "docs/110 requires dry-run preflight")
    require("confirmed ledger input" in shell_accounting_real_broker_order_authorization_gate, "docs/110 requires confirmed ledger input")
    require("final user confirmation" in shell_accounting_real_broker_order_authorization_gate, "docs/110 requires final user confirmation")
    require("independent authorization token" in shell_accounting_real_broker_order_authorization_gate, "docs/110 requires independent token")
    require("kill switch" in shell_accounting_real_broker_order_authorization_gate, "docs/110 documents kill switch")
    require("reconciliation required" in shell_accounting_real_broker_order_authorization_gate, "docs/110 documents reconciliation")
    require("TASK-156" in shell_accounting_real_broker_order_implementation_gate, "docs/112 mentions TASK-156")
    require(
        "Test Matrix" in shell_accounting_real_broker_order_implementation_test_plan,
        "docs/113 contains Test matrix",
    )
    require("TASK-156" in codex_prompt_template, "docs/12 mentions TASK-156")
    require("no broker adapter implementation" in shell_accounting_real_broker_order_implementation_gate, "docs/112 forbids broker adapter")
    require("no broker SDK" in shell_accounting_real_broker_order_implementation_gate, "docs/112 forbids broker SDK")
    require("no broker network call" in shell_accounting_real_broker_order_implementation_gate, "docs/112 forbids broker network call")
    require("no credentials or secrets" in shell_accounting_real_broker_order_implementation_gate, "docs/112 forbids credentials")
    require("CI network calls disabled" in shell_accounting_real_broker_order_implementation_gate, "docs/112 documents CI broker network ban")
    require("no StrategyEngine execution" in shell_accounting_real_broker_order_implementation_test_plan, "docs/113 forbids strategy execution")
    require("no automatic trading" in shell_accounting_real_broker_order_implementation_test_plan, "docs/113 forbids automatic trading")
    require("TASK-157" in shell_accounting_broker_adapter_interface_scaffold, "docs/114 mentions TASK-157")
    require("TASK-157" in codex_prompt_template, "docs/12 mentions TASK-157")
    require("ShellAccountingBrokerOrderPort" in shell_accounting_broker_adapter_interface_scaffold, "docs/114 documents broker order port")
    require("disabled/null adapter" in shell_accounting_broker_adapter_interface_scaffold, "docs/114 documents disabled/null adapter")
    require("Test-only Fake Adapter Policy" in shell_accounting_broker_adapter_interface_scaffold, "docs/114 documents test-only fake")
    require("No Broker SDK Policy" in shell_accounting_broker_adapter_interface_scaffold, "docs/114 documents no SDK policy")
    ...
    require("TASK-160" in shell_accounting_broker_sandbox_adapter_authorization_gate, "docs/118 mentions TASK-160")
    require("TASK-160" in shell_accounting_broker_sandbox_adapter_authorization_test_plan, "docs/119 mentions TASK-160")
    require("TASK-160" in codex_prompt_template, "docs/12 mentions TASK-160")
    require("Sandbox Adapter Future Boundary" in shell_accounting_broker_sandbox_adapter_authorization_gate, "docs/118 documents sandbox future boundary")
    require("Disabled Default Policy" in shell_accounting_broker_sandbox_adapter_authorization_gate, "docs/118 documents disabled default")
    require("Sandbox / Paper / Real Mode Isolation" in shell_accounting_broker_sandbox_adapter_authorization_gate, "docs/118 documents mode isolation")
    require("Credentials Isolation Policy" in shell_accounting_broker_sandbox_adapter_authorization_gate, "docs/118 documents credentials isolation")
    require("CI No-Network Policy" in shell_accounting_broker_sandbox_adapter_authorization_gate, "docs/118 documents CI no-network")
    require("DataService-Only Broker Adapter Boundary" in shell_accounting_broker_sandbox_adapter_authorization_gate, "docs/118 documents DataService-only broker boundary")
    require("No Broker SDK Policy" in shell_accounting_broker_sandbox_adapter_authorization_gate, "docs/118 documents no SDK")
    require("No Real Order Placement Policy" in shell_accounting_broker_sandbox_adapter_authorization_gate, "docs/118 documents no real order placement")
    ...
    require("TASK-162" in shell_accounting_broker_sandbox_mode_selector, "docs/122 mentions TASK-162")
    require("TASK-162" in shell_accounting_broker_sandbox_mode_selector_test_plan, "docs/123 mentions TASK-162")
    require("TASK-162" in codex_prompt_template, "docs/12 mentions TASK-162")
    require("disabled-default selector" in shell_accounting_broker_sandbox_mode_selector, "docs/122 documents disabled-default selector")
    require("not runtime broker enablement" in shell_accounting_broker_sandbox_mode_selector, "docs/122 says selector is not runtime broker enablement")
    require("sandbox mode only selects TASK-161 scaffold" in shell_accounting_broker_sandbox_mode_selector, "docs/122 documents sandbox scaffold-only mode")
    require("unknown mode fail closed" in shell_accounting_broker_sandbox_mode_selector, "docs/122 documents unknown fail-closed")
    require("CI no-network" in shell_accounting_broker_sandbox_mode_selector, "docs/122 documents CI no-network")
    require("credentials isolation" in shell_accounting_broker_sandbox_mode_selector, "docs/122 documents credentials isolation")
    require("no real broker order id" in shell_accounting_broker_sandbox_mode_selector, "docs/122 forbids real broker order id")
    require("no order placement" in shell_accounting_broker_sandbox_mode_selector, "docs/122 forbids order placement")
    require("Test Matrix" in shell_accounting_broker_sandbox_mode_selector_test_plan, "docs/123 contains Test matrix")
    require("Required Probes" in shell_accounting_broker_sandbox_mode_selector_test_plan, "docs/123 documents required probes")
    require("TASK-163" in shell_accounting_broker_sandbox_runtime_selector_authorization_gate, "docs/124 mentions TASK-163")
    require(
        "TASK-163" in shell_accounting_broker_sandbox_runtime_selector_authorization_test_plan,
        "docs/125 mentions TASK-163",
    )
    require("TASK-163" in codex_prompt_template, "docs/12 mentions TASK-163")
    require(
        "runtime selector wiring requires separate authorization"
        in shell_accounting_broker_sandbox_runtime_selector_authorization_gate,
        "docs/124 requires separate runtime wiring authorization",
    )
    require(
        "default must remain disabled" in shell_accounting_broker_sandbox_runtime_selector_authorization_gate,
        "docs/124 preserves disabled default",
    )
    require(
        "sandbox runtime can only select TASK-161 scaffold"
        in shell_accounting_broker_sandbox_runtime_selector_authorization_gate,
        "docs/124 keeps sandbox runtime scaffold-only until separate authorization",
    )
    require(
        "unknown / empty / paper / real mode must fail closed"
        in shell_accounting_broker_sandbox_runtime_selector_authorization_gate,
        "docs/124 requires unknown modes fail closed",
    )
    require(
        "runtime mode source requires separate authorization"
        in shell_accounting_broker_sandbox_runtime_selector_authorization_gate,
        "docs/124 requires runtime mode source authorization",
    )
    require(
        "credentials injection requires separate authorization"
        in shell_accounting_broker_sandbox_runtime_selector_authorization_gate,
        "docs/124 requires credentials injection authorization",
    )
    require(
        "CI no-network" in shell_accounting_broker_sandbox_runtime_selector_authorization_gate,
        "docs/124 documents CI no-network",
    )
    require(
        "rollback to TASK-159 disabled provider"
        in shell_accounting_broker_sandbox_runtime_selector_authorization_gate,
        "docs/124 documents rollback to TASK-159",
    )
    require(
        "Test Matrix" in shell_accounting_broker_sandbox_runtime_selector_authorization_test_plan,
        "docs/125 contains Test matrix",
    )
    require(
        "Required Probes" in shell_accounting_broker_sandbox_runtime_selector_authorization_test_plan,
        "docs/125 documents required probes",
    )
    require("TASK-164" in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring, "docs/126 mentions TASK-164")
    require(
        "TASK-164" in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_test_plan,
        "docs/127 mentions TASK-164",
    )
    require("TASK-164" in codex_prompt_template, "docs/12 mentions TASK-164")
    require(
        "disabled-default runtime selector wiring" in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring,
        "docs/126 documents disabled-default runtime selector wiring",
    )
    require(
        "runtime mode source not authorized" in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring,
        "docs/126 keeps runtime mode source unauthorized",
    )
    require(
        "sandbox runtime not enabled" in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring,
        "docs/126 states sandbox runtime is not enabled",
    )
    require(
        "sandbox scaffold does not enter runtime" in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring,
        "docs/126 keeps sandbox scaffold out of runtime",
    )
    require(
        "default remains disabled" in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring,
        "docs/126 keeps default disabled",
    )
    require(
        "CI no-network" in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring,
        "docs/126 documents CI no-network",
    )
    require(
        "credentials isolation" in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring,
        "docs/126 documents credentials isolation",
    )
    require(
        "no real broker order id" in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring,
        "docs/126 forbids real broker order id",
    )
    require(
        "no order placement" in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring,
        "docs/126 forbids order placement",
    )
    require(
        "Test Matrix" in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_test_plan,
        "docs/127 contains Test matrix",
    )
    require("TASK-165" in shell_accounting_broker_runtime_mode_source_authorization_gate, "docs/128 mentions TASK-165")
    require(
        "TASK-165" in shell_accounting_broker_runtime_mode_source_authorization_test_plan,
        "docs/129 mentions TASK-165",
    )
    require("TASK-165" in codex_prompt_template, "docs/12 mentions TASK-165")
    require(
        "runtime mode source authorization gate" in shell_accounting_broker_runtime_mode_source_authorization_gate,
        "docs/128 documents runtime mode source authorization gate",
    )
    require(
        "mode source not implemented" in shell_accounting_broker_runtime_mode_source_authorization_gate,
        "docs/128 states mode source is not implemented",
    )
    require(
        "sandbox runtime remains disabled" in shell_accounting_broker_runtime_mode_source_authorization_gate,
        "docs/128 keeps sandbox runtime disabled",
    )
    require(
        "DataService-only future boundary" in shell_accounting_broker_runtime_mode_source_authorization_gate,
        "docs/128 documents DataService-only future boundary",
    )
    require(
        "default disabled provider remains active" in shell_accounting_broker_runtime_mode_source_authorization_gate,
        "docs/128 keeps default disabled provider active",
    )
    require(
        "CI no-network" in shell_accounting_broker_runtime_mode_source_authorization_gate,
        "docs/128 documents CI no-network",
    )
    require(
        "credentials isolation" in shell_accounting_broker_runtime_mode_source_authorization_gate,
        "docs/128 documents credentials isolation",
    )
    require(
        "rollback to TASK-159 disabled/null provider" in shell_accounting_broker_runtime_mode_source_authorization_gate,
        "docs/128 documents rollback to TASK-159 disabled/null provider",
    )
    require(
        "no real broker order id" in shell_accounting_broker_runtime_mode_source_authorization_gate,
        "docs/128 forbids real broker order id",
    )
    require(
        "no order placement" in shell_accounting_broker_runtime_mode_source_authorization_gate,
        "docs/128 forbids order placement",
    )
    require(
        "Test Matrix" in shell_accounting_broker_runtime_mode_source_authorization_test_plan,
        "docs/129 contains Test matrix",
    )
    require(
        "Required Probes" in shell_accounting_broker_runtime_mode_source_authorization_test_plan,
        "docs/129 contains Required Probes",
    )
    require("TASK-166" in shell_accounting_broker_runtime_mode_source_disabled_scaffold, "docs/130 mentions TASK-166")
    require(
        "TASK-166" in shell_accounting_broker_runtime_mode_source_disabled_scaffold_test_plan,
        "docs/131 mentions TASK-166",
    )
    require("TASK-166" in codex_prompt_template, "docs/12 mentions TASK-166")
    require(
        "disabled-only internal broker runtime mode source" in shell_accounting_broker_runtime_mode_source_disabled_scaffold,
        "docs/130 documents disabled-only internal source",
    )
    require(
        "External runtime mode source remains unauthorized"
        in shell_accounting_broker_runtime_mode_source_disabled_scaffold,
        "docs/130 keeps external runtime mode source unauthorized",
    )
    require(
        "default source returns disabled" in shell_accounting_broker_runtime_mode_source_disabled_scaffold_test_plan,
        "docs/131 checks default source disabled",
    )
    require(
        "Test Matrix" in shell_accounting_broker_runtime_mode_source_disabled_scaffold_test_plan,
        "docs/131 contains Test matrix",
    )
    require(
        "Required Probes" in shell_accounting_broker_runtime_mode_source_disabled_scaffold_test_plan,
        "docs/131 contains Required Probes",
    )
    require(
        "TASK-167" in shell_accounting_broker_sandbox_runtime_mode_source_authorization_gate,
        "docs/132 mentions TASK-167",
    )
    require(
        "TASK-167" in shell_accounting_broker_sandbox_runtime_mode_source_authorization_test_plan,
        "docs/133 mentions TASK-167",
    )
    require("TASK-167" in codex_prompt_template, "docs/12 mentions TASK-167")
    require(
        "authorization gate only" in shell_accounting_broker_sandbox_runtime_mode_source_authorization_gate,
        "docs/132 documents gate-only scope",
    )
    require(
        "does not implement sandbox mode source selection"
        in shell_accounting_broker_sandbox_runtime_mode_source_authorization_gate,
        "docs/132 forbids sandbox mode source implementation",
    )
    require(
        "Sandbox runtime is not enabled" in shell_accounting_broker_sandbox_runtime_mode_source_authorization_gate,
        "docs/132 keeps sandbox runtime disabled",
    )
    require(
        "Test Matrix" in shell_accounting_broker_sandbox_runtime_mode_source_authorization_test_plan,
        "docs/133 contains Test matrix",
    )
    require(
        "Required Probes" in shell_accounting_broker_sandbox_runtime_mode_source_authorization_test_plan,
        "docs/133 contains Required Probes",
    )
    require(
        "TASK-168" in shell_accounting_broker_sandbox_runtime_mode_source_scaffold,
        "docs/134 mentions TASK-168",
    )
    require(
        "TASK-168" in shell_accounting_broker_sandbox_runtime_mode_source_scaffold_test_plan,
        "docs/135 mentions TASK-168",
    )
    require("TASK-168" in codex_prompt_template, "docs/12 mentions TASK-168")
    require(
        "not runtime enablement" in shell_accounting_broker_sandbox_runtime_mode_source_scaffold,
        "docs/134 states scaffold is not runtime enablement",
    )
    require(
        "default runtime source remains disabled-only"
        in shell_accounting_broker_sandbox_runtime_mode_source_scaffold,
        "docs/134 keeps default runtime source disabled-only",
    )
    require(
        "Test Matrix" in shell_accounting_broker_sandbox_runtime_mode_source_scaffold_test_plan,
        "docs/135 contains Test matrix",
    )
    require(
        "Required Probes" in shell_accounting_broker_sandbox_runtime_mode_source_scaffold_test_plan,
        "docs/135 contains Required Probes",
    )
    require(
        "TASK-169" in shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_gate,
        "docs/136 mentions TASK-169",
    )
    require(
        "TASK-169" in shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_test_plan,
        "docs/137 mentions TASK-169",
    )
    require("TASK-169" in codex_prompt_template, "docs/12 mentions TASK-169")
    require(
        "authorization gate only" in shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_gate,
        "docs/136 documents gate-only scope",
    )
    require(
        "does not implement that selector"
        in shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_gate,
        "docs/136 forbids selector implementation",
    )
    require(
        "default runtime source remains disabled-only"
        in shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_gate,
        "docs/136 keeps default source disabled-only",
    )
    require(
        "Test Matrix" in shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_test_plan,
        "docs/137 contains Test matrix",
    )
    require(
    ...
    require(
        "TASK-173" in shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_gate,
        "docs/144 mentions TASK-173",
    )
    require(
        "TASK-173" in shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_test_plan,
        "docs/145 mentions TASK-173",
    )
    require("TASK-173" in codex_prompt_template, "docs/12 mentions TASK-173")
    require(
        "does not enable sandbox runtime" in shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_gate,
        "docs/144 keeps sandbox runtime disabled",
    )
    require(
        "Test Matrix" in shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_test_plan,
        "docs/145 contains Test matrix",
    )
    require(
        "Required Probes" in shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_test_plan,
        "docs/145 contains Required Probes",
    )
    require(
        "TASK-174" in shell_accounting_broker_sandbox_runtime_enablement_state_scaffold,
        "docs/146 mentions TASK-174",
    )
    require(
        "TASK-174" in shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_test_plan,
        "docs/147 mentions TASK-174",
    )
    require("TASK-174" in codex_prompt_template, "docs/12 mentions TASK-174")
    require(
        "defaultShellAccountingBrokerSandboxRuntimeEnablementState"
        in shell_accounting_broker_sandbox_runtime_enablement_state_scaffold,
        "docs/146 documents default enablement state scaffold",
    )
    require(
        "disabled, unavailable, and fail-closed"
        in shell_accounting_broker_sandbox_runtime_enablement_state_scaffold,
        "docs/146 documents disabled/unavailable/fail-closed default",
    )
    require(
        "Test Matrix" in shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_test_plan,
        "docs/147 contains Test matrix",
    )
    require(
        "Required Probes" in shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_test_plan,
        "docs/147 contains Required Probes",
    )
    require(
        "TASK-174" in shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_gate,
        "docs/144 mentions TASK-174",
    )
    require(
    ...
    require(
        ...
        "docs/142 mentions TASK-173",
    )
    require(
        "TASK-173" in shell_accounting_broker_sandbox_runtime_mode_source_selector_disabled_wiring_test_plan,
        "docs/143 mentions TASK-173",
    )
    require(
        "Required Probes" in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_test_plan,
        "docs/127 documents required probes",
    )
    ...
    require(
        ...
        "docs/105 mentions TASK-153",
    )
    require("TASK-153" in shell_accounting_production_trading_ui_implementation, "docs/106 mentions TASK-153")
    ...
    for ctest_name in [
        "shell_accounting_production_trading_ui_implementation",
        "shell_accounting_production_trading_ui_authorized_page_or_section",
        "shell_accounting_production_trading_ui_create_draft_binding",
        "shell_accounting_production_trading_ui_confirm_draft_binding",
        "shell_accounting_production_trading_ui_user_confirmation_required",
        "shell_accounting_production_trading_ui_no_direct_dataserviceclient",
        "shell_accounting_production_trading_ui_no_direct_db_write",
        "shell_accounting_production_trading_ui_no_broker_order",
        "shell_accounting_production_trading_ui_no_strategy_execution",
        "shell_accounting_production_trading_ui_no_auto_trading",
        "shell_accounting_production_trading_ui_error_mapping",
        "shell_accounting_production_trading_ui_privacy",
        "shell_accounting_production_trading_ui_rollback_ready",
    ]:
        require(
            ctest_name in shell_accounting_production_trading_ui_implementation_cmake,
            f"TASK-152 tests include {ctest_name}",
        )
    for ctest_name in [
        "shell_accounting_broker_order_authorization_gate",
    ...
    for ctest_name in [
        "shell_accounting_real_broker_order_authorization_gate",
        "shell_accounting_real_broker_order_authorization_no_real_order_yet",
        "shell_accounting_real_broker_order_authorization_dataservice_only_policy",
        "shell_accounting_real_broker_order_authorization_requires_dry_run_preflight",
        "shell_accounting_real_broker_order_authorization_requires_confirmed_ledger",
        "shell_accounting_real_broker_order_authorization_requires_final_user_confirmation",
        "shell_accounting_real_broker_order_authorization_independent_token_policy",
        "shell_accounting_real_broker_order_authorization_broker_adapter_boundary_policy",
        "shell_accounting_real_broker_order_authorization_risk_control_policy",
        "shell_accounting_real_broker_order_authorization_idempotency_policy",
        "shell_accounting_real_broker_order_authorization_audit_policy",
        "shell_accounting_real_broker_order_authorization_reconciliation_policy",
        "shell_accounting_real_broker_order_authorization_no_strategy_execution",
        "shell_accounting_real_broker_order_authorization_no_auto_trading",
        "shell_accounting_real_broker_order_authorization_no_ui_direct_broker",
        "shell_accounting_real_broker_order_authorization_kill_switch_policy",
        "shell_accounting_real_broker_order_authorization_error_mapping_policy",
        "shell_accounting_real_broker_order_authorization_rollback_policy",
    ]:
        require(
            ctest_name in shell_accounting_real_broker_order_authorization_gate_cmake,
            f"TASK-155 tests include {ctest_name}",
        )
    for ctest_name in [
        "shell_accounting_real_broker_order_implementation_gate",
        "shell_accounting_real_broker_order_implementation_no_real_order_yet",
        "shell_accounting_real_broker_order_implementation_no_broker_adapter_yet",
        "shell_accounting_real_broker_order_implementation_no_broker_sdk",
        ...
        "shell_accounting_real_broker_order_implementation_dataservice_only_policy",
        "shell_accounting_real_broker_order_implementation_requires_dry_run_preflight",
        "shell_accounting_real_broker_order_implementation_requires_confirmed_ledger",
        "shell_accounting_real_broker_order_implementation_requires_final_confirmation",
        "shell_accounting_real_broker_order_implementation_independent_token_policy",
        "shell_accounting_real_broker_order_implementation_sandbox_real_isolation_policy",
        "shell_accounting_real_broker_order_implementation_risk_preflight_policy",
        "shell_accounting_real_broker_order_implementation_idempotency_policy",
        "shell_accounting_real_broker_order_implementation_audit_policy",
        "shell_accounting_real_broker_order_implementation_reconciliation_policy",
        "shell_accounting_real_broker_order_implementation_no_strategy_execution",
        "shell_accounting_real_broker_order_implementation_no_auto_trading",
        "shell_accounting_real_broker_order_implementation_no_ui_direct_broker",
        "shell_accounting_real_broker_order_implementation_kill_switch_policy",
        "shell_accounting_real_broker_order_implementation_error_mapping_policy",
        "shell_accounting_real_broker_order_implementation_rollback_policy",
    ]:
        require(
            ctest_name in shell_accounting_real_broker_order_implementation_gate_cmake,
            f"TASK-156 tests include {ctest_name}",
        )
    for ctest_name in [
        "shell_accounting_broker_adapter_interface_scaffold",
        "shell_accounting_broker_adapter_interface_no_sdk",
        "shell_accounting_broker_adapter_interface_no_network_call",
        "shell_accounting_broker_adapter_interface_no_credentials",
        "shell_accounting_broker_adapter_interface_disabled_default",
        "shell_accounting_broker_adapter_interface_fake_test_only",
        "shell_accounting_broker_adapter_interface_no_real_order_id",
        "shell_accounting_broker_adapter_interface_no_database_write",
        "shell_accounting_broker_adapter_interface_no_qml_exposure",
        "shell_accounting_broker_adapter_interface_no_presenter_broker",
        "shell_accounting_broker_adapter_interface_no_strategy_execution",
        "shell_accounting_broker_adapter_interface_no_auto_trading",
        "shell_accounting_broker_adapter_interface_error_mapping",
        "shell_accounting_broker_adapter_interface_rollback_policy",
    ]:
        require(
    ...
    for ctest_name in [
        "shell_accounting_broker_sandbox_adapter_authorization_gate",
        "shell_accounting_broker_sandbox_adapter_no_adapter_yet",
        "shell_accounting_broker_sandbox_adapter_disabled_default",
        "shell_accounting_broker_sandbox_adapter_mode_isolation",
        "shell_accounting_broker_sandbox_adapter_fake_test_only",
        "shell_accounting_broker_sandbox_adapter_no_sdk",
        "shell_accounting_broker_sandbox_adapter_no_network_call",
        "shell_accounting_broker_sandbox_adapter_no_credentials",
        "shell_accounting_broker_sandbox_adapter_no_real_order_placement",
        "shell_accounting_broker_sandbox_adapter_no_real_order_id_storage",
        "shell_accounting_broker_sandbox_adapter_no_reconciliation",
        "shell_accounting_broker_sandbox_adapter_no_cancellation_correction",
        "shell_accounting_broker_sandbox_adapter_no_strategy_execution",
        "shell_accounting_broker_sandbox_adapter_no_auto_trading",
        "shell_accounting_broker_sandbox_adapter_no_qml_presenter_exposure",
        "shell_accounting_broker_sandbox_adapter_preserves_disabled_wiring",
        "shell_accounting_broker_sandbox_adapter_preserves_dry_run_boundary",
        "shell_accounting_broker_sandbox_adapter_rollback_policy",
    ]:
        require(
    ...
    for ctest_name in [
        "shell_accounting_broker_sandbox_mode_selector_compiles",
        "shell_accounting_broker_sandbox_mode_selector_default_disabled",
        "shell_accounting_broker_sandbox_mode_selector_unknown_fail_closed",
        "shell_accounting_broker_sandbox_mode_selector_disabled_mode",
        "shell_accounting_broker_sandbox_mode_selector_sandbox_scaffold_mode",
        "shell_accounting_broker_sandbox_mode_selector_sandbox_success_false",
        "shell_accounting_broker_sandbox_mode_selector_sandbox_no_broker_order_id",
        "shell_accounting_broker_sandbox_mode_selector_default_provider_unchanged",
        "shell_accounting_broker_sandbox_mode_selector_no_dataserviceactions_runtime_change",
        "shell_accounting_broker_sandbox_mode_selector_no_qml_startup_presenter_exposure",
        "shell_accounting_broker_sandbox_mode_selector_no_broker_sdk",
        "shell_accounting_broker_sandbox_mode_selector_no_network",
        "shell_accounting_broker_sandbox_mode_selector_no_credentials_read",
        "shell_accounting_broker_sandbox_mode_selector_no_endpoint_or_secret_values",
        "shell_accounting_broker_sandbox_mode_selector_no_database_write",
        "shell_accounting_broker_sandbox_mode_selector_no_ledger_or_audit_write",
        "shell_accounting_broker_sandbox_mode_selector_no_order_placement",
        "shell_accounting_broker_sandbox_mode_selector_no_reconciliation_cancellation_correction",
        "shell_accounting_broker_sandbox_mode_selector_no_strategy_or_auto_trading",
        "shell_accounting_broker_sandbox_mode_selector_docs",
        "shell_accounting_broker_sandbox_mode_selector_task160_161_regression",
    ]:
        require(
            ctest_name in shell_accounting_broker_sandbox_mode_selector_cmake,
            f"TASK-162 tests include {ctest_name}",
        )
    for ctest_name in [
        "shell_accounting_broker_sandbox_runtime_selector_authorization_gate",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_docs_index",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_disabled_default_runtime_wiring_only",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_default_provider_disabled",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_selector_not_in_startup",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_no_qml_presenter_exposure",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_no_broker_sdk",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_no_network",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_no_credentials_read",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_no_endpoint_or_secret_values",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_no_real_broker_order_id",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_no_order_placement",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_no_database_audit_ledger_write",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_no_reconciliation_cancellation_correction",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_no_strategy_or_auto_trading",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_task160_161_162_regression",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_docs_tests_policy_keywords_not_production",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_future_runtime_wiring_requires_new_task",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_fail_closed_policy",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_no_runtime_mode_source",
        "shell_accounting_broker_sandbox_runtime_selector_authorization_no_credentials_injection",
    ]:
        require(
            ctest_name in shell_accounting_broker_sandbox_runtime_selector_authorization_cmake,
            f"TASK-163 tests include {ctest_name}",
        )
    for ctest_name in [
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_docs",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_dataserviceactions_uses_selector",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_default_mode_only",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_no_sandbox_paper_real_runtime_strings",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_no_payload_mode_source",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_no_external_mode_source",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_runtime_disabled_semantics",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_error_code_unchanged",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_broker_port_mode_disabled",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_sandbox_not_runtime",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_direct_sandbox_scaffold_unavailable",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_unknown_mode_fail_closed",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_task163_gate_updated",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_no_qml_startup_presenter_exposure",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_no_broker_sdk",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_no_network",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_no_credentials_or_endpoint",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_no_real_broker_order_id",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_no_order_placement",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_no_new_database_audit_ledger_write",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_no_reconciliation_cancellation_correction",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_no_strategy_or_auto_trading",
        "shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_docs_tests_policy_keywords_not_production",
    ]:
        require(
            ctest_name in shell_accounting_broker_sandbox_runtime_selector_disabled_wiring_cmake,
            f"TASK-164 tests include {ctest_name}",
        )
    for ctest_name in [
        "shell_accounting_broker_runtime_mode_source_authorization_gate",
        "shell_accounting_broker_runtime_mode_source_authorization_docs_index",
        "shell_accounting_broker_runtime_mode_source_authorization_dataserviceactions_default_mode_only",
        "shell_accounting_broker_runtime_mode_source_authorization_no_payload_mode_source",
        "shell_accounting_broker_runtime_mode_source_authorization_no_qml_presenter_mode_source",
        "shell_accounting_broker_runtime_mode_source_authorization_no_config_env_cli_file_db_secret_source",
        "shell_accounting_broker_runtime_mode_source_authorization_sandbox_runtime_not_enabled",
        "shell_accounting_broker_runtime_mode_source_authorization_default_provider_disabled",
        "shell_accounting_broker_runtime_mode_source_authorization_no_broker_sdk",
        "shell_accounting_broker_runtime_mode_source_authorization_no_network",
        "shell_accounting_broker_runtime_mode_source_authorization_no_credentials_or_endpoint",
        "shell_accounting_broker_runtime_mode_source_authorization_no_real_broker_order_id",
        "shell_accounting_broker_runtime_mode_source_authorization_no_order_placement",
        "shell_accounting_broker_runtime_mode_source_authorization_no_database_audit_ledger_write",
        "shell_accounting_broker_runtime_mode_source_authorization_no_reconciliation_cancellation_correction",
        "shell_accounting_broker_runtime_mode_source_authorization_no_strategy_or_auto_trading",
        "shell_accounting_broker_runtime_mode_source_authorization_task160_to_164_baseline",
        "shell_accounting_broker_runtime_mode_source_authorization_docs_tests_policy_keywords_not_production",
        "shell_accounting_broker_runtime_mode_source_authorization_rollback_policy",
        "shell_accounting_broker_runtime_mode_source_authorization_future_authorization_required",
    ]:
        require(
            ctest_name in shell_accounting_broker_runtime_mode_source_authorization_cmake,
            f"TASK-165 tests include {ctest_name}",
        )
    for ctest_name in [
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_docs",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_source_compiles",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_direct_instantiation",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_default_source_disabled",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_dataserviceactions_uses_source",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_dataserviceactions_disabled_mode_only",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_runtime_dry_run_disabled",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_broker_port_mode_disabled",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_error_code_unchanged",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_sandbox_scaffold_not_runtime",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_direct_sandbox_scaffold_unavailable",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_unknown_mode_fail_closed",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_no_payload_mode_source",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_no_qml_presenter_startup_mode_source",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_no_config_env_cli_file_db_secret_source",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_no_broker_sdk",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_no_network",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_no_credentials_or_endpoint",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_no_real_broker_order_id",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_no_order_placement",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_no_database_audit_ledger_write",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_no_reconciliation_cancellation_correction",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_no_strategy_or_auto_trading",
        "shell_accounting_broker_runtime_mode_source_disabled_scaffold_task160_to_165_baseline",
    ]:
        require(
            ctest_name in shell_accounting_broker_runtime_mode_source_disabled_scaffold_cmake,
            f"TASK-166 tests include {ctest_name}",
        )
    for ctest_name in [
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_gate",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_docs_index",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_no_sandbox_source_implementation",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_no_payload_mode_source",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_no_qml_presenter_controller_startup_source",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_no_config_env_cli_file_db_secret_source",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_runtime_source_disabled_only",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_default_source_disabled",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_sandbox_runtime_not_enabled",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_direct_sandbox_scaffold_unavailable",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_paper_real_not_implemented",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_no_broker_sdk",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_no_network_or_endpoint",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_no_credentials_or_secret_values",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_no_real_broker_order_id",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_no_order_placement",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_no_db_audit_ledger_write",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_no_reconciliation_cancellation_correction",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_no_strategy_or_auto_trading",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_task166_baseline",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_task165_baseline",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_docs_tests_policy_keywords_not_production",
        "shell_accounting_broker_sandbox_runtime_mode_source_authorization_rollback_policy",
    ]:
        require(
            ctest_name in shell_accounting_broker_sandbox_runtime_mode_source_authorization_cmake,
            f"TASK-167 tests include {ctest_name}",
        )
    for ctest_name in [
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_docs",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_docs_index",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_header_declares_scaffold",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_source_defines_scaffold",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_direct_instantiation_returns_sandbox",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_default_source_still_disabled",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_dataserviceactions_not_using_sandbox_source",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_runtime_dry_run_disabled_provider",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_runtime_broker_port_mode_disabled",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_runtime_broker_port_disabled_true",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_runtime_broker_port_dry_run_only_true",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_direct_sandbox_source_selector_scaffold_unavailable",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_no_payload_source",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_no_qml_startup_presenter_controller_source",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_no_config_env_cli_file_db_secret_source",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_no_credentials_endpoint_account_order_data",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_paper_real_sources_not_implemented",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_no_broker_sdk",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_no_network_endpoint",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_no_credentials_secret_values",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_no_real_order_id",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_no_order_placement",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_no_db_audit_ledger_write",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_no_reconciliation_cancellation_correction",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_no_strategy_auto_trading",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_schema_not_modified",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_task167_gate_still_valid",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_task166_disabled_scaffold_still_valid",
        "shell_accounting_broker_sandbox_runtime_mode_source_scaffold_rollback_policy",
    ]:
        require(
            ctest_name in shell_accounting_broker_sandbox_runtime_mode_source_scaffold_cmake,
            f"TASK-168 tests include {ctest_name}",
        )
    for ctest_name in [
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_gate",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_docs_index",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_no_selector_implementation",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_runtime_source_unchanged",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_dataserviceactions_not_wired",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_default_source_disabled",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_sandbox_runtime_disabled",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_scaffold_direct_test_only",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_direct_scaffold_returns_sandbox",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_direct_sandbox_scaffold_unavailable",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_fail_closed_policy_documented",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_no_payload_qml_config_env_cli_file_db_secret_source",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_no_credentials_endpoint_account_order_data",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_paper_real_not_implemented",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_no_broker_sdk",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_no_network_endpoint",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_no_credentials_secret_values",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_no_real_order_id",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_no_order_placement",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_no_db_audit_ledger_write",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_no_reconciliation_cancellation_correction",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_no_strategy_auto_trading",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_schema_not_modified",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_task168_scaffold_still_valid",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_task167_gate_still_valid",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_task166_disabled_still_valid",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_docs_tests_policy_keywords_not_production",
        "shell_accounting_broker_sandbox_runtime_mode_source_selector_authorization_rollback_policy",
    ]:
        require(
    ...
    for ctest_name in [
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_docs",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_docs_index",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_dataserviceactions_disabled_default_wiring",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_no_dataserviceactions_sandbox_paper_real",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_no_mode_source_inputs",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_runtime_source_production_unchanged",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_default_runtime_source_disabled",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_selected_runtime_source_disabled",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_broker_port_mode_disabled",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_broker_port_disabled_true",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_broker_port_dry_run_only_true",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_sandbox_runtime_not_enabled",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_sandbox_scaffold_direct_test_only",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_direct_sandbox_selector_unavailable",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_paper_real_not_implemented",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_no_broker_sdk",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_no_network_endpoint",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_no_credentials_secret_values",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_no_real_order_id",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_no_order_placement",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_no_db_audit_ledger_write",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_no_reconciliation_cancellation_correction",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_no_strategy_auto_trading",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_schema_not_modified",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_task172_still_valid",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_task171_still_valid",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_task170_still_valid",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_task166_still_valid",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_docs_tests_policy_keywords_not_production",
        "shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_rollback_policy",
    ]:
        require(
            ctest_name in shell_accounting_broker_sandbox_runtime_mode_enablement_authorization_cmake,
            f"TASK-173 tests include {ctest_name}",
        )
    for ctest_name in [
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_docs",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_docs_index",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_header_declares_state",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_source_defines_default",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_default_enabled_false",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_default_available_false",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_default_fail_closed_true",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_default_runtime_mode_stable",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_default_status_stable",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_default_error_code_stable",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_no_runtime_injection_api",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_dataserviceactions_not_modified",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_dataserviceactions_not_wired",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_dataserviceactions_disabled_default_wiring",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_no_dataserviceactions_sandbox_paper_real",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_runtime_source_production_unchanged",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_default_runtime_source_disabled",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_selected_runtime_source_disabled",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_sandbox_runtime_not_enabled",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_selector_direct_test_only",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_direct_sandbox_selector_unavailable",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_paper_real_not_implemented",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_no_external_mode_source",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_no_credentials_endpoint_account_order_data",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_no_broker_sdk",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_no_network_endpoint",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_no_credentials_secret_values",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_no_real_order_id",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_no_order_placement",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_no_db_audit_ledger_write",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_no_reconciliation_cancellation_correction",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_no_strategy_auto_trading",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_schema_not_modified",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_task173_gate_evolved",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_task172_still_valid",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_task166_still_valid",
        "shell_accounting_broker_sandbox_runtime_enablement_state_scaffold_rollback_policy",
    ]:
        require(
    ...
    for required_qml_trading_ui_token in [
        ...
        require(
            required_qml_trading_ui_token in qml_sources,
            f"production QML includes authorized TASK-152 token {required_qml_trading_ui_token}",
        )
