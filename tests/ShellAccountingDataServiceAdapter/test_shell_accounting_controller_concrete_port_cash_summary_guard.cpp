...
int main(int argc, char* argv[])
{
    ...
    const auto result =
        etfdt::shell_services::tests::refreshControllerThroughConcretePort(server, "cash.summary");
