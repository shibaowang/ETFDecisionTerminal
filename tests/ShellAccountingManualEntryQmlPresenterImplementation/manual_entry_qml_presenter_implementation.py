...
def main() -> int:
    ...
    for forbidden in [
        ...
        require(not any(path.startswith(forbidden) and path not in (TASK_257_EXACT_PATHS | EPIC_276_EXACT_PATHS) for path in changes), f"TASK-200 must not change {forbidden}")
    for forbidden in [
        "libs/DataServiceApi/include/DataServiceApi/DataServiceActions.h",
        "libs/DataServiceApi/src/DataServiceActionRegistrar.cpp",
