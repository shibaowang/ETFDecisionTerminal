...
def main() -> int:
    ...
    allowed_changes = task218_allowed_changes | task219_allowed_changes | task220_allowed_changes
    ...
    if changes:
        gate.require(
            changes in [task218_allowed_changes, task219_allowed_changes, task220_allowed_changes],
