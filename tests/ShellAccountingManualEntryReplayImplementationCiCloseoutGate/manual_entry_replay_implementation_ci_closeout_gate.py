...
def validate_clean_main_invariants(gate: Gate, root: Path) -> None:
    for path in CRITICAL_SCRIPTS:
        ...
        gate.require(
            ...
            f"{path.as_posix()} does not recursively run full CTest",
        )
