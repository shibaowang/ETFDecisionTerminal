...
EPIC_289_PRODUCTION_EXACT_PATHS = {
    "apps/ETFDecisionShell/qml/pages/ShellAccountingReadOnlyPage.qml",
    "libs/DataServiceApi/CMakeLists.txt",
    "libs/DataServiceApi/include/DataServiceApi/DataServiceActions.h",
    "libs/DataServiceApi/src/DataServiceActionRegistrar.cpp",
...
def validate_changed_paths(validator: Validator, root: Path) -> None:
    ...
    ALLOWED_CHANGED_PATHS.update(EPIC_276_EXACT_PATHS)
    ALLOWED_CHANGED_PATHS.update(EPIC_278_EXACT_PATHS)
    ...
    validator.require(
        not any(
            ...
            and path not in EPIC_276_EXACT_PATHS
            and path not in EPIC_278_EXACT_PATHS
            and path not in EPIC_289_PRODUCTION_EXACT_PATHS
            for path in changes
        ),
...
TASK_265_EXCEL_VBA_IMPORT_MANUAL_ENTRY_PERSISTENCE_PATHS = {
    "libs/DataAccess/CMakeLists.txt",
    "libs/DataAccess/include/DataAccess/ShellAccountingExcelVbaImportManualEntryPersistenceRepository.h",
    "libs/DataAccess/include/DataAccess/ShellAccountingManualTransactionRepository.h",
    "libs/DataAccess/src/ShellAccountingExcelVbaImportManualEntryPersistenceRepository.cpp",
...
if "ALLOWED_CHANGED_PATHS" in globals():
    ALLOWED_CHANGED_PATHS.update(EPIC_289_FIX_EXACT_PATHS)
if "EPIC_277_ALLOWED_CHANGED_PATHS" in globals():
    EPIC_277_ALLOWED_CHANGED_PATHS.update(EPIC_289_FIX_EXACT_PATHS)
