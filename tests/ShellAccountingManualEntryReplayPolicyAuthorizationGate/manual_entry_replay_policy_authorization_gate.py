...
def main() -> int:
    ...
    for prefix in forbidden_prefixes:
        gate.require(not any(path.startswith(prefix) and path not in (TASK_257_EXACT_PATHS | EPIC_276_EXACT_PATHS) for path in changes), f"TASK-213 must not change {prefix}")
