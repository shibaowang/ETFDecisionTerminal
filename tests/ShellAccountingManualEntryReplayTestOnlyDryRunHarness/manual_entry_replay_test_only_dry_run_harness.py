...
def validate_changed_paths(harness: Harness, root: Path) -> None:
    ...
    harness.require((git_lines(root, "diff", "--name-only", "main", "--", "apps") - {"apps/ETFDecisionShell/qml/pages/ShellAccountingReadOnlyPage.qml"} - EPIC_287_GLOBAL_CHINESE_UI_READABILITY_EXACT_PATHS - EPIC_289_FIX_EXACT_PATHS) == set(), "apps diff empty")
