...
int main(int argc, char** argv)
{
    ...
    const auto portAdapterText = readFile(portAdapterHeader) + "\n" + readFile(portAdapterSource);
    expectTrue(portAdapterText.find("DataServiceClient/DataServiceClient.h") != std::string::npos, "only concrete port adapter includes DataServiceClient");
    expectTrue(portAdapterText.find("positionList(") != std::string::npos, "concrete port calls positionList wrapper");
