...
[[nodiscard]] std::string docs110Text(const std::filesystem::path& root);
[[nodiscard]] std::string docs111Text(const std::filesystem::path& root);
...
[[nodiscard]] std::vector<std::string> realBrokerImplementationTokens();
[[nodiscard]] std::vector<std::string> brokerAdapterTokens();
[[nodiscard]] std::vector<std::string> sandboxPaperBrokerTokens();
[[nodiscard]] std::vector<std::string> networkBrokerCallTokens();
