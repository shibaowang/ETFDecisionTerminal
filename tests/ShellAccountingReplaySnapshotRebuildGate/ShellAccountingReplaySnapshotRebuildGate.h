...
namespace etfdt::tests::shell_accounting_replay_snapshot_rebuild_gate {
...
[[nodiscard]] std::filesystem::path docs84Path(const std::filesystem::path& root);
[[nodiscard]] std::filesystem::path docs85Path(const std::filesystem::path& root);
...
[[nodiscard]] std::vector<std::string> replayForbiddenTokens();
[[nodiscard]] std::vector<std::string> snapshotWriteForbiddenTokens();
[[nodiscard]] std::vector<std::string> uiDirectForbiddenTokens();
[[nodiscard]] std::vector<std::string> writeSqlForbiddenTokens();
