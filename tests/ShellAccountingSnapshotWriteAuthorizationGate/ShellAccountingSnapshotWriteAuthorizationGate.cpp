...
std::filesystem::path docs92Path(const std::filesystem::path& root)
{
    return root / "docs" / "92_shell_accounting_snapshot_write_authorization_gate.md";
}

std::filesystem::path docs93Path(const std::filesystem::path& root)
{
    return root / "docs" / "93_shell_accounting_snapshot_write_authorization_test_plan.md";
}

std::filesystem::path docs91Path(const std::filesystem::path& root)
{
    return root / "docs" / "91_shell_accounting_snapshot_rebuild_implementation.md";
}
